...
@section('content')
       <h1>{{$title}}</h1>
        <p>
            Hey!
            My name is Ber and I am a young web developer trying to constantly expand my knowledge and skills!
            I have experience building small applications in Ruby on Rails and a working understanding of C# .NET.
